...
define config.name = _("Mystery of the haunted house")
...
define build.name = "Mysteryofthehauntedhouse"
...
define config.save_directory = "Mysteryofthehauntedhouse-1569307113"
